...
class DCAVisualizer:
    ...
    def _plot_contact_map_rna(self,ax=None):
    ...
    def _plot_contact_map_protein(self,ax=None):
    ...
    def plot_contact_map(self,ax_arg = None):
        ...
        """
        if self.__biomolecule == 'RNA':
            contact_categories_dict = self._plot_contact_map_rna(ax_arg)
            return contact_categories_dict
        elif self.__biomolecule == 'PROTEIN':
            contact_categories_dict = self._plot_contact_map_protein(ax_arg)
        else:
    ...
    def plot_true_positive_rates(self):
        ...
        plt.tight_layout()
        #plt.show()
        return true_positive_rates_dict, ax
