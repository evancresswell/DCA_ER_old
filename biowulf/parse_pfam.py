...
def parse_pfam(data_dir='./'):
    ...
    if os.path.exists(pfam_file):
        ...
        #    'stockholm')
        alignments = AlignIO.parse(open(os.path.join(data_dir, 'Pfam-A.full'),'r') ,'stockholm')
        ...
        for i, a in enumerate(alignments):
            ...
            print('saving fasta to ',pfam_dir)
            AlignIO.write(a,open(os.path.join(pfam_dir,'/msa.fa')),'fasta')		
